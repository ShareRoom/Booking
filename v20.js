      ...
      .then((rep) => {
        ...
        bookTimeElements.forEach((ele) => {
          ...
          data.map((item) => {
            ...
            console.log('minute convert: ', minute);

            let bookedTimeFormatted = `${hour}:${minute}`
            console.log('bookedTimeCFormatted: ', bookedTimeFormatted);
